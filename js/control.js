$(document).ready(() => {
  ...
  Code Reference
  Code Academy
  URL: https://www.codecademy.com/courses/learn-jquery-effects/lessons/jquery-effects/exercises/toggle?course_redirect=learn-jquery
  */
  $(".nybutton").on('click',() => {
        $(".nypic").toggle();
        $(".nypicdisc").toggle();
  ...
  Code Reference
  Code Academy
  URL: https://www.codecademy.com/courses/learn-jquery-effects/lessons/jquery-effects/exercises/fade-toggle?course_redirect=learn-jquery
  */
  $(".seabutton").on('click',() => {
